...
const Display = () => {
  return (
    <div className="taskout">
        ...
        <div className="task">
        <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor" class="bi bi-cloud-rain" viewBox="0 0 16 16">
        ...
        <div>
            <h2 className="location-text">Nashik</h2>
            <h5>32 <span>&#176;</span> C</h5>
        </div>
        </div>

        <Button variant="secondary" className="small-cross-button">
        &#x2715;
        </Button>
